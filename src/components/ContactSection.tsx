            ...
            <div className="space-y-6 animate-slide-in-soft">
              ...
              <div className="space-y-4">
                {contactMethods.map((method, index) => (
                  <Card 
                    key={index}
                    className="border-2 border-primary/20 shadow-soft hover:shadow-elegant hover-lift transition-all cursor-pointer"
                  >
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        ...
                        <Button 
                          variant="outline" 
                          size="sm"
                          className="border-primary/40 hover:bg-primary/10 transition-all"
                        >
                          {method.action}
                        </Button>
                      </div>
